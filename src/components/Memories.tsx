      ...
      <div className="bg-slate-800/50 p-4 rounded-xl border border-slate-700/60 flex justify-between items-center">
        <div>
          <h2 className="text-xl font-semibold text-white flex items-center gap-2">
            ...
            Hosszútávú Memória (Memory Vault)
          </h2>
          <p className="text-sm text-slate-400">
            A csapat által önállóan tanult vagy kézzel hozzáadott tények állandó tára.
          </p>
        </div>
        {!isAdding && (
          <button
          ...
          <div className="space-y-3">
            <div>
              ...
              <input
                ...
                placeholder="Pl. Ügyfél preference / Cégadatok"
      ...
      <div className="space-y-4">
        <div className="relative">
          ...
          <input
            ...
            placeholder="Keresés tények, memóriatöredékek között..."
          ...
          {filteredMemories.length === 0 ? (
            ...
            filteredMemories.map(memory => (
              ...
              >
                ...
                <div className="border-t border-slate-750/50 mt-3 pt-2 text-[10px] text-slate-500 font-mono flex justify-between items-center">
